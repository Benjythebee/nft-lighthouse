...
/**
 * Takes into account negative/positive values and does the math to add/remove quantity
 * @param chain 
 * @param ownersData 
 * @returns 
 */
export const upsertAndComputeOwnersOfNFTs = async (chain:Network,ownersData:(OwnersData)[]) => {
    ...
    console.log(`[${chain}] Added new values for `+ Object.keys(byAddresses).join(', '))
